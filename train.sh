...
python train_str.py --arch segnet_two_heads --dataset table_str_two_heads --img_rows 768 --img_cols 2048 --l_rate 1e-4 --n_epoch 500
# python train_str.py --arch pspnet_two_heads --dataset table_str_two_heads --img_rows 512 --img_cols 2048 --l_rate 1e-4 --n_epoch 250
